...
void ADS1X15::_requestADC(uint16_t readmode)
{
  ...
  config |= _compQueConvert;          //  bit 0..1   ALERT mode
   SERIAL_PORT.print("CONFIG: ");
   SERIAL_PORT.println(config,BIN);
   SERIAL_PORT.print("ADR: ");
   SERIAL_PORT.println(_address,HEX);
