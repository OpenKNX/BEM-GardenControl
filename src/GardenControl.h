...
#define LOG_ParamBlockOffset 28
...
// Parameter per channel
#define BEM_ParamBlockOffset 888
...
#define BEM_KoCalcIndex(number) ((number >= BEM_KoCalcNumber(0) && number < BEM_KoCalcNumber(BEM_KoBlockSize)) ? (number - BEM_KoOffset) % BEM_KoBlockSize : -1)
...
// Parameter per channel
#define REL_ParamBlockOffset 900
...
#define REL_KoCalcIndex(number) ((number >= REL_KoCalcNumber(0) && number < REL_KoCalcNumber(REL_KoBlockSize)) ? (number - REL_KoOffset) % REL_KoBlockSize : -1)
...
// Parameter per channel
#define ADC_ParamBlockOffset 903
...
#define ADC_KoCalcIndex(number) ((number >= ADC_KoCalcNumber(0) && number < ADC_KoCalcNumber(ADC_KoBlockSize)) ? (number - ADC_KoOffset) % ADC_KoBlockSize : -1)
...
// Parameter per channel
#define CUR_ParamBlockOffset 948
...
#define CUR_KoCalcIndex(number) ((number >= CUR_KoCalcNumber(0) && number < CUR_KoCalcNumber(CUR_KoBlockSize)) ? (number - CUR_KoOffset) % CUR_KoBlockSize : -1)
...
// Parameter per channel
#define BIN_ParamBlockOffset 978
